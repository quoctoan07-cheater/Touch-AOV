...
bool Done() {
    ...
    if (!is_done) {
        ...
        if (getTouch != nullptr) {
            UnityEngine_Input_GetTouch = (Touch (*)(int))getTouch;
        }
        if (getCount != nullptr) {
            UnityEngine_Input_get_touchCount = (int (*)())getCount;
        }
        is_done = true;
    }

    return (UnityEngine_Input_GetTouch != nullptr && UnityEngine_Input_get_touchCount != nullptr);
}
...
void UpdateTouchInput() {
    ...
    int touchCount = 0;
    touchCount = UnityEngine_Input_get_touchCount();
